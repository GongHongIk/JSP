	...
	private void doHandle(HttpServletRequest request, HttpServletResponse response) 
		...
		try {
			...
			if (action==null){	
				...
				pw.print("<script>" + "  alert('새 글이 작성되었습니다.');" + " location.href='" + 
				...
				PrintWriter pw = response.getWriter();
				pw.print("<script>" + "  alert('수정이 완료되었습니다..');" + " location.href='" + request.getContextPath()
				...
				PrintWriter pw = response.getWriter();
				pw.print("<script>" + "  alert('글을 삭제했습니다.';" + "</script>");
				return;
